...
class Listify_Customizer {
	...
	public static function customizer_scripts() {
		wp_enqueue_script( 'listify-customizer', get_template_directory_uri() . '/inc/customizer/assets/js/customizer-admin.js', array( 'jquery' ), 20170316 );
	...
	public static function customizer_scripts_preview( $wp_customize ) {
		...
		wp_enqueue_script( 'listify-customizer-preview', get_template_directory_uri() . '/inc/customizer/assets/js/customizer-preview.js', array( 'jquery', 'underscore', 'webfont' ), 20161212, true );
