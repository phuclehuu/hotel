...
<div id="step-status-theme-updater" class="step-status step-<?php if ( ! $is_valid ) : ?>in<?php endif; ?>complete" data-string-complete="<?php _e( 'Completed', 'listify' ); ?>" data-string-incomplete="<?php _e( 'Not Complete', 'listify' ); ?>"><?php echo ( $is_valid ? __( 'Complete', 'listify' ) : __( 'Not Complete', 'listify' ) ); ?></div>
